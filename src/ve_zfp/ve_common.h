...
#define VL    256 /* Maximum vector length (256 x 64 elements)  */
#define WSIZE  64 /* number of bits in a buffered word */
...
static const uint8_t perm_1[4] __attribute__((aligned(8))) = {
  0, 1, 2, 3
};
...
static const uint8_t perm_2[16] __attribute__((aligned(8))) = {
  index(0, 0), /*  0 : 0 */
...
static const uint8_t perm_3[64] __attribute__((aligned(8))) = {
  index(0, 0, 0), /*  0 : 0 */
...
static const uint8_t perm_4[256] __attribute__((aligned(8))) = {
  index(0, 0, 0, 0), /*   0 :  0 */
